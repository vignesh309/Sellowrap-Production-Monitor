...
// 🚨 Don't forget your Excel Export function!
function exportToExcel() {
    ...
    let workbook = XLSX.utils.table_to_book(table, { sheet: "LineProcess OEE", raw: true });
    let dateStr = document.getElementById('start_date').value;
    XLSX.writeFile(workbook, `LineProcess_OEE_${dateStr}.xlsx`);
}